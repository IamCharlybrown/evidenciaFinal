                    ...
                    @foreach($users as $user)
                        <tr class="border-t">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-right">
                                <a href="{{ route('users.show', $user) }}" class="text-green-600 hover:text-green-900" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-right">
                                <a href="{{ route('users.edit', $user) }}" class="text-blue-600 hover:text-blue-900 ml-4" title="Edit">
