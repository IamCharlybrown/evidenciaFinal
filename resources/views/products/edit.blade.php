    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <form action="{{ route('products.update', $product) }}" method="POST" class="mt-6 space-y-4">
            ...
            <div class="flex flex-col space-y-4">
                ...
                <div>
                    <label for="stock" class="block text-sm font-medium text-gray-700">Description</label>
                    <textarea type="text" name="description" id="description" value="{{ $product->description }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
